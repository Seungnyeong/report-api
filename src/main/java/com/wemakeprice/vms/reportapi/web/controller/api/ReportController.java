...
public class ReportController {
    ...
    public ResponseEntity<InputStreamResource> printReport(@PathVariable Long diagnosis_table_id) throws Exception {
        ...
        return   ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION,  String.format("attachment;filename=\"%1$s\";", URLEncoder.encode(reportFile.getFileName() + "취약점 점검 결과 보고", StandardCharsets.UTF_8)))
